...
# Edited by K1ks for Toggle Hmp/Eas
...
if [ -e /sys/devices/system/cpu/cpu0/cpufreq/scaling_available_governors ]; then
 ...
 AGB=/sys/devices/system/cpu/cpu3/cpufreq/scaling_available_governors
 ...
 AGB=/sys/devices/system/cpu/cpu5/cpufreq/scaling_available_governors
elif [ -e /sys/devices/system/cpu/cpu6/cpufreq/scaling_available_governors ]; then
 AGB=/sys/devices/system/cpu/cpu6/cpufreq/scaling_available_governors
elif [ -e /sys/devices/system/cpu/cpu7/cpufreq/scaling_available_governors ]; then
 AGB=/sys/devices/system/cpu/cpu7/cpufreq/scaling_available_governors
elif [ -e /sys/devices/system/cpu/cpu8/cpufreq/scaling_available_governors ]; then
 AGB=/sys/devices/system/cpu/cpu8/cpufreq/scaling_available_governors
elif [ -e /sys/devices/system/cpu/cpu9/cpufreq/scaling_available_governors ]; then
 AGB=/sys/devices/system/cpu/cpu9/cpufreq/scaling_available_governors
fi;
...
ui_print ""
sleep 0.2
ui_print " Note: Unlock Game Graphics And Fps By Changing Device Name "
ui_print " Unlock game graphic such as Call of Duty Mobile,"
ui_print " PUBG, Asphalt, Blade&Soul Revolution etc"
...
#
case $GU in
1 ) TEXT2="✓PUBGM Unlocked "; FCTEXTAD1="PUBG Mobile"; sed -i '/ro.product.model/s/.*/ro.product.model=IN2023/' $props; sed -i '/ro.product.manufacturer/s/.*/ro.product.manufacturer=OnePlus/' $props;;
...
set_permissions() {
  ...
  set_perm  $MODPATH/system/bin/gaming  0  0  0755
}
